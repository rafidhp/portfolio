      ...
      <div className="container max-w-6xl">
        ...
        >
          <Card className="md:col-span-2 p-6 glass flex flex-col gap-4">
            ...
            <Button variant="outline" className="mt-auto glass hover:bg-primary/10 hover:border-primary">
              <a href="/cv.pdf" className="flex gap-1 justify-center items-center hover:cursor-pointer" download>
          ...
          <Card className="md:col-span-3 p-6 glass">
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full gradient-primary text-primary-foreground border-0 shadow-elegant hover:shadow-glow transition-smooth"
              >
